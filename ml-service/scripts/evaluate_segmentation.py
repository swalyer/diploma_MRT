...
def main() -> int:
    ...
    parser.add_argument("--dataset-root", type=Path, required=True,
                        help="Root containing imagesTs/ and labelsTs/ folders")
    ...
    labels_dir = args.dataset_root / "labelsTs"
    if not images_dir.exists() or not labels_dir.exists():
        logger.error("Expected imagesTs/ and labelsTs/ inside %s", args.dataset_root)
        return 2
